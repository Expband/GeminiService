...
class VertexModel:
    ...
    def science_tutoring(self):
        chat_model = ChatModel.from_pretrained("chat-bison@001")

        chat = chat_model.start_chat(
            context="""Ти асистент, який працює в службі підтримки клієнтів на сайті з передбачення ціни криптовалюти. 
            Якщо відповідь на репліку користувача є в твоїй базі знань - використовуй відповідь з неї. В іншому випадку
            використовуй данні з інтернету.""",
            examples=[
                InputOutputTextPair(
                    input_text="Привіт",
